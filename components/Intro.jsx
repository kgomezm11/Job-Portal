    ...
    <>
      <div className='w-full  h-full flex items-center lg:justify-start py-24 justify-center flex-wrap  '>
        <div className='lg:w-3/6 w-full sm:p-2 h-full my-2 flex items-center justify-center px-4 md:items-start md:justify-start md:p-20 flex-col '>
          <h1 className='md:text-6xl text-2xl sm:text-2xl font-extrabold mb-4 text-black '>Elige <span className='text-indigo-600'>Tu Nuevo Empleo.</span> </h1>
          <p className='md:text-lg sm:text-sm text-xs mb-20 text-gray-400'>Muchas personas visitan este portal diario para enterarse de las múltiples opciones de mercado!</p>
          <div className='bg-white flex-col mb-6 w-full md:px-4   py-4 flex sm:flex-row items-center justify-center'>
            ...
            <input onChange={(e) => setSearch(e.target.value)} type="text" placeholder='Elige una categoría' className='xs:w-full w-3/4  h-full px-2 bg-gray-200 text-base py-3 outline-none' />
            <button onClick={handleSearch} className='px-3 py-2 my-2 sm:my-0 border border-indigo-600 rounded uppercase tracking-widest mx-4   text-white bg-indigo-600 transition-all duration-700 hover:bg-transparent font-semibold text-base hover:text-indigo-600'>Buscar</button>
          </div>
          <div className=' w-full px-2 py-2 flex items-center justify-start flex-wrap'>
            <div className='flex items-center justify-center'>
              ...
              <h1 className='font-semibold text-lg'>Sugerencias : </h1>
            </div>
            <div className='flex   items-center justify-center px-4 flex-wrap'>
              ...
              <p className='px-2  text-gray-600'>QA</p>
            </div>
          </div>
        </div>
          ...
          <div className='w-full flex flex-wrap items-center justify-center py-2 px-2'>
            {
              ...
              }) : <p className='text-sm text-center font-semibold  text-red-500'>No existen empleos con esta categoría</p>
            }
          </div>
        )
      }
